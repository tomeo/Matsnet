...
{:ok, project1} = Matsnet.Projects.create_project(%{title: "Project 1"})
{:ok, project2} = Matsnet.Projects.create_project(%{title: "Project 2"})
{:ok, project3} = Matsnet.Projects.create_project(%{title: "Project 3"})
{:ok, project4} = Matsnet.Projects.create_project(%{title: "Project 4"})

Matsnet.Tasks.create_task(%{title: "Task 1", project_id: project1.id})
Matsnet.Tasks.create_task(%{title: "Task 2", project_id: project2.id})
Matsnet.Tasks.create_task(%{title: "Task 3", project_id: project3.id})
Matsnet.Tasks.create_task(%{title: "Task 4", project_id: project4.id})
