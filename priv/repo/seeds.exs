...
Matsnet.Repo.insert(%Matsnet.UserTasks{user_id: 1, task_id: 1})
Matsnet.Repo.insert(%Matsnet.UserTasks{user_id: 1, task_id: 2})
Matsnet.Repo.insert(%Matsnet.UserTasks{user_id: 2, task_id: 2})
Matsnet.Repo.insert(%Matsnet.UserTasks{user_id: 2, task_id: 3})
